...
-- ===================================================================
-- Request methods — fully valid EmmyLua, no & syntax
-- ===================================================================
...
-- Response body: loop.dap.proto.SetBreakpointsResponse
...
-- Response body: loop.dap.proto.ThreadsResponse
---@param callback fun(response: loop.dap.proto.Response)|nil
function BaseSession:request_threads(callback)
self:_request("threads", nil, callback)
end

-- Response body: loop.dap.proto.StackTraceResponse
...
-- Response body: loop.dap.proto.ScopesResponse
...
-- Response body: loop.dap.proto.VariablesResponse
...
-- Response body: loop.dap.proto.ContinueResponse
...
-- Response body: loop.dap.proto.EvaluateResponse
...
-- Remaining requests — no strict response body defined in spec
---@param args table
---@param callback fun(response: loop.dap.proto.Response)|nil
