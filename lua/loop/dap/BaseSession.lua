...
-- Internal helper to normalize DAP responses into (err, body)
...
-- Execution Controls (continue / pause / next / step)
...
-- Evaluate / Variables / SetExpression / SetVariable
...
-- Loaded Sources, Breakpoint Locations, Exception Info
...
-- Advanced Requests (DataBreakpointInfo, DataBreakpoints, ReadMemory, WriteMemory, Disassemble)
